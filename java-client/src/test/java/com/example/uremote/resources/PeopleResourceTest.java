...
public class PeopleResourceTest {
    ...
    public static final ResourceTestRule RESOURCES = ResourceTestRule.builder()
            ...
            .build();
    @Captor
    private ArgumentCaptor<com.example.uremote.core.Person> personCaptor;
    private com.example.uremote.core.Person person;

    @Before
    public void setUp() {
        person = new com.example.uremote.core.Person();
    ...
    public void createPerson() throws JsonProcessingException {
        when(PERSON_DAO.create(any(com.example.uremote.core.Person.class))).thenReturn(person);
    ...
    public void listPeople() throws Exception {
        final ImmutableList<com.example.uremote.core.Person> people = ImmutableList.of(person);
        when(PERSON_DAO.findAll()).thenReturn(people);

        final List<com.example.uremote.core.Person> response = RESOURCES.target("/people")
            .request().get(new GenericType<List<com.example.uremote.core.Person>>() {
            });
